...
import br.com.sicoob.contacorrente.auth.Authentication;
import br.com.sicoob.contacorrente.auth.HttpBasicAuth;
import br.com.sicoob.contacorrente.auth.HttpBearerAuth;
import br.com.sicoob.contacorrente.auth.ApiKeyAuth;
import br.com.sicoob.contacorrente.auth.OAuth;
import br.com.sicoob.contacorrente.auth.RetryingOAuth;
import br.com.sicoob.contacorrente.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.sicoob.com.br/conta-corrente/v4";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.sicoob.com.br/conta-corrente/v4",
    ...
    public ApiClient() {
        ...
        authentications.put("id_token", new ApiKeyAuth("header", "id_token"));
        authentications.put("x-idempotency-key", new ApiKeyAuth("header", "x-idempotency-key"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://auth.sicoob.com.br/auth/realms/cooperado/protocol/openid-connect/token";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.1.1.43/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sicoob.com.br/conta-corrente/v4)
     ...
     * @return a {@link br.com.sicoob.contacorrente.ApiClient} object
     */
    ...
    */
     ...
     * @throws br.com.sicoob.contacorrente.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws br.com.sicoob.contacorrente.ApiException If fail to serialize the given object
     */
     ...
     * @throws br.com.sicoob.contacorrente.ApiException If fail to read file content from response and write to disk
     ...
     * @throws br.com.sicoob.contacorrente.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws br.com.sicoob.contacorrente.ApiException If the response has an unsuccessful status code or
     ...
     * @throws br.com.sicoob.contacorrente.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws br.com.sicoob.contacorrente.ApiException If fails to update the parameters
     */
     ...
     * @throws br.com.sicoob.contacorrente.ApiException If fail to serialize the request body object into a string
     */
