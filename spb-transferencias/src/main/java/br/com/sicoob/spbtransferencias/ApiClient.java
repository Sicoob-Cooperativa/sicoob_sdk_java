...
import br.com.sicoob.spbtransferencias.auth.Authentication;
import br.com.sicoob.spbtransferencias.auth.HttpBasicAuth;
import br.com.sicoob.spbtransferencias.auth.HttpBearerAuth;
import br.com.sicoob.spbtransferencias.auth.ApiKeyAuth;
import br.com.sicoob.spbtransferencias.auth.OAuth;
import br.com.sicoob.spbtransferencias.auth.RetryingOAuth;
import br.com.sicoob.spbtransferencias.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.sicoob.com.br/spb/v2";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.sicoob.com.br/spb/v2",
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.4.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sicoob.com.br/spb/v2)
     ...
     * @return a {@link br.com.sicoob.spbtransferencias.ApiClient} object
     */
    ...
    */
     ...
     * @throws br.com.sicoob.spbtransferencias.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws br.com.sicoob.spbtransferencias.ApiException If fail to serialize the given object
     */
     ...
     * @throws br.com.sicoob.spbtransferencias.ApiException If fail to read file content from response and write to disk
     ...
     * @throws br.com.sicoob.spbtransferencias.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws br.com.sicoob.spbtransferencias.ApiException If the response has an unsuccessful status code or
     ...
     * @throws br.com.sicoob.spbtransferencias.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws br.com.sicoob.spbtransferencias.ApiException If fails to update the parameters
     */
     ...
     * @throws br.com.sicoob.spbtransferencias.ApiException If fail to serialize the request body object into a string
     */
