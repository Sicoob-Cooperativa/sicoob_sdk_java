...
import br.com.sicoob.openfinance.auth.Authentication;
import br.com.sicoob.openfinance.auth.HttpBasicAuth;
import br.com.sicoob.openfinance.auth.HttpBearerAuth;
import br.com.sicoob.openfinance.auth.ApiKeyAuth;
import br.com.sicoob.openfinance.auth.OAuth;
import br.com.sicoob.openfinance.auth.RetryingOAuth;
import br.com.sicoob.openfinance.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.sicoob.com.br/payments/v2/itp";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.sicoob.com.br/payments/v2/itp",
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.1.2.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sicoob.com.br/payments/v2/itp)
     ...
     * @return a {@link br.com.sicoob.openfinance.ApiClient} object
     */
    ...
    */
     ...
     * @throws br.com.sicoob.openfinance.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws br.com.sicoob.openfinance.ApiException If fail to serialize the given object
     */
     ...
     * @throws br.com.sicoob.openfinance.ApiException If fail to read file content from response and write to disk
     ...
     * @throws br.com.sicoob.openfinance.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws br.com.sicoob.openfinance.ApiException If the response has an unsuccessful status code or
     ...
     * @throws br.com.sicoob.openfinance.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws br.com.sicoob.openfinance.ApiException If fails to update the parameters
     */
     ...
     * @throws br.com.sicoob.openfinance.ApiException If fail to serialize the request body object into a string
     */
