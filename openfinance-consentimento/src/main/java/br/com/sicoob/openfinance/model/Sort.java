...
public class Sort {
  ...
  public Sort empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
  ...
  public Sort sorted(@javax.annotation.Nullable Boolean sorted) {
    this.sorted = sorted;
    return this;
  }
  ...
  public Sort unsorted(@javax.annotation.Nullable Boolean unsorted) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("empty", "sorted", "unsorted"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sort.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Sort is not found in the empty JSON string", Sort.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sort.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Sort` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
