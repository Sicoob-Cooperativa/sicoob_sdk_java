...
public class StatusRetorno {
  ...
  public StatusRetorno status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
  ...
  public StatusRetorno codigo(@javax.annotation.Nullable Integer codigo) {
    this.codigo = codigo;
    return this;
  }
  ...
  public StatusRetorno mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public boolean equals(Object o) {
    ...
    StatusRetorno statusRetorno = (StatusRetorno) o;
    return Objects.equals(this.status, statusRetorno.status) &&
        Objects.equals(this.codigo, statusRetorno.codigo) &&
        Objects.equals(this.mensagem, statusRetorno.mensagem);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, codigo, mensagem);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "codigo", "mensagem"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusRetorno
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusRetorno.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StatusRetorno is not found in the empty JSON string", StatusRetorno.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusRetorno.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusRetorno' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusRetorno> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusRetorno.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusRetorno>() {
           @Override
           public void write(JsonWriter out, StatusRetorno value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatusRetorno read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatusRetorno given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatusRetorno
   * @throws IOException if the JSON string is invalid with respect to StatusRetorno
   */
  public static StatusRetorno fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusRetorno.class);
  }

  /**
   * Convert an instance of StatusRetorno to an JSON string
   *
   * @return JSON string
   */
