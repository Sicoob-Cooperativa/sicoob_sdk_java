...
import br.com.sicoob.conveniopagamentos.model.DebitosResultado;
...
public class Debitos {
  ...
  private DebitosResultado resultado;

  public Debitos() {
  }

  public Debitos resultado(@javax.annotation.Nullable DebitosResultado resultado) {
   ...
   */
  @javax.annotation.Nullable
  public DebitosResultado getResultado() {
    return resultado;
  }

  public void setResultado(@javax.annotation.Nullable DebitosResultado resultado) {
    this.resultado = resultado;
  }
  ...
  public boolean equals(Object o) {
    ...
    Debitos debitos = (Debitos) o;
    return Objects.equals(this.resultado, debitos.resultado);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Debitos
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Debitos.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Debitos is not found in the empty JSON string", Debitos.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Debitos.openapiFields.contains(entry.getKey())) {
          // throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Debitos` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `resultado`
      if (jsonObj.get("resultado") != null && !jsonObj.get("resultado").isJsonNull()) {
        DebitosResultado.validateJsonElement(jsonObj.get("resultado"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Debitos.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Debitos' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Debitos> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Debitos.class));

       return (TypeAdapter<T>) new TypeAdapter<Debitos>() {
           @Override
           public void write(JsonWriter out, Debitos value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Debitos read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Debitos given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Debitos
   * @throws IOException if the JSON string is invalid with respect to Debitos
   */
  public static Debitos fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Debitos.class);
  }

  /**
   * Convert an instance of Debitos to an JSON string
   *
   * @return JSON string
   */
