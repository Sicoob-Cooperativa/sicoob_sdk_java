...
public class OcorrenciaEspecial {
  ...
  public OcorrenciaEspecial() {
  }

  public OcorrenciaEspecial mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public OcorrenciaEspecial codigo(@javax.annotation.Nullable String codigo) {
    this.codigo = codigo;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OcorrenciaEspecial ocorrenciaEspecial = (OcorrenciaEspecial) o;
    return Objects.equals(this.mensagem, ocorrenciaEspecial.mensagem) &&
        Objects.equals(this.codigo, ocorrenciaEspecial.codigo);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OcorrenciaEspecial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OcorrenciaEspecial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OcorrenciaEspecial is not found in the empty JSON string", OcorrenciaEspecial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OcorrenciaEspecial.openapiFields.contains(entry.getKey())) {
          // throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OcorrenciaEspecial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OcorrenciaEspecial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OcorrenciaEspecial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OcorrenciaEspecial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OcorrenciaEspecial.class));

       return (TypeAdapter<T>) new TypeAdapter<OcorrenciaEspecial>() {
           @Override
           public void write(JsonWriter out, OcorrenciaEspecial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OcorrenciaEspecial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OcorrenciaEspecial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OcorrenciaEspecial
   * @throws IOException if the JSON string is invalid with respect to OcorrenciaEspecial
   */
  public static OcorrenciaEspecial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OcorrenciaEspecial.class);
  }

  /**
   * Convert an instance of OcorrenciaEspecial to an JSON string
   *
   * @return JSON string
   */
