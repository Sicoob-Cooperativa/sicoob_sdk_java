...
public class RetornoOptante {
  ...
  public RetornoOptante() {
  }

  public RetornoOptante mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public RetornoOptante codigo(@javax.annotation.Nullable String codigo) {
    this.codigo = codigo;
    return this;
  }
  ...
  public RetornoOptante autenticacao(@javax.annotation.Nullable String autenticacao) {
  ...
  public boolean equals(Object o) {
    ...
    RetornoOptante retornoOptante = (RetornoOptante) o;
    return Objects.equals(this.mensagem, retornoOptante.mensagem) &&
        Objects.equals(this.codigo, retornoOptante.codigo) &&
        Objects.equals(this.autenticacao, retornoOptante.autenticacao);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetornoOptante
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetornoOptante.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RetornoOptante is not found in the empty JSON string", RetornoOptante.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetornoOptante.openapiFields.contains(entry.getKey())) {
          // throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RetornoOptante` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetornoOptante.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetornoOptante' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetornoOptante> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetornoOptante.class));

       return (TypeAdapter<T>) new TypeAdapter<RetornoOptante>() {
           @Override
           public void write(JsonWriter out, RetornoOptante value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetornoOptante read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetornoOptante given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetornoOptante
   * @throws IOException if the JSON string is invalid with respect to RetornoOptante
   */
  public static RetornoOptante fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetornoOptante.class);
  }

  /**
   * Convert an instance of RetornoOptante to an JSON string
   *
   * @return JSON string
   */
