...
import br.com.sicoob.conveniopagamentos.model.ConveniosResultadoInner;
...
public class Convenios {
  ...
  private List<ConveniosResultadoInner> resultado = new ArrayList<>();

  public Convenios() {
  }

  public Convenios resultado(@javax.annotation.Nullable List<ConveniosResultadoInner> resultado) {
    this.resultado = resultado;
    return this;
  }

  public Convenios addResultadoItem(ConveniosResultadoInner resultadoItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ConveniosResultadoInner> getResultado() {
    return resultado;
  }

  public void setResultado(@javax.annotation.Nullable List<ConveniosResultadoInner> resultado) {
    this.resultado = resultado;
  }
  ...
  public boolean equals(Object o) {
    ...
    Convenios convenios = (Convenios) o;
    return Objects.equals(this.resultado, convenios.resultado);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Convenios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Convenios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Convenios is not found in the empty JSON string", Convenios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Convenios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Convenios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("resultado") != null && !jsonObj.get("resultado").isJsonNull()) {
        ...
        if (jsonArrayresultado != null) {
          ...
          for (int i = 0; i < jsonArrayresultado.size(); i++) {
            ConveniosResultadoInner.validateJsonElement(jsonArrayresultado.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Convenios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Convenios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Convenios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Convenios.class));

       return (TypeAdapter<T>) new TypeAdapter<Convenios>() {
           @Override
           public void write(JsonWriter out, Convenios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Convenios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Convenios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Convenios
   * @throws IOException if the JSON string is invalid with respect to Convenios
   */
  public static Convenios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Convenios.class);
  }

  /**
   * Convert an instance of Convenios to an JSON string
   *
   * @return JSON string
   */
