...
import br.com.sicoob.conveniopagamentos.model.ConciliacaoResultadoInner;
...
public class Conciliacao {
  ...
  private List<ConciliacaoResultadoInner> resultado = new ArrayList<>();

  public Conciliacao() {
  }

  public Conciliacao resultado(@javax.annotation.Nullable List<ConciliacaoResultadoInner> resultado) {
    this.resultado = resultado;
    return this;
  }

  public Conciliacao addResultadoItem(ConciliacaoResultadoInner resultadoItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ConciliacaoResultadoInner> getResultado() {
    return resultado;
  }

  public void setResultado(@javax.annotation.Nullable List<ConciliacaoResultadoInner> resultado) {
    this.resultado = resultado;
  }
  ...
  public boolean equals(Object o) {
    ...
    Conciliacao conciliacao = (Conciliacao) o;
    return Objects.equals(this.resultado, conciliacao.resultado);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Conciliacao
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Conciliacao.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Conciliacao is not found in the empty JSON string", Conciliacao.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Conciliacao.openapiFields.contains(entry.getKey())) {
          // throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Conciliacao` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("resultado") != null && !jsonObj.get("resultado").isJsonNull()) {
        ...
        if (jsonArrayresultado != null) {
          ...
          for (int i = 0; i < jsonArrayresultado.size(); i++) {
            ConciliacaoResultadoInner.validateJsonElement(jsonArrayresultado.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Conciliacao.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Conciliacao' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Conciliacao> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Conciliacao.class));

       return (TypeAdapter<T>) new TypeAdapter<Conciliacao>() {
           @Override
           public void write(JsonWriter out, Conciliacao value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Conciliacao read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Conciliacao given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Conciliacao
   * @throws IOException if the JSON string is invalid with respect to Conciliacao
   */
  public static Conciliacao fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Conciliacao.class);
  }

  /**
   * Convert an instance of Conciliacao to an JSON string
   *
   * @return JSON string
   */
