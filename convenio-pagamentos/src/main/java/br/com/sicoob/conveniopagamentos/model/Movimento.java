...
public class Movimento {
  ...
  public Movimento mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public Movimento codigo(@javax.annotation.Nullable CodigoEnum codigo) {
    this.codigo = codigo;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mensagem, movimento.mensagem) &&
        Objects.equals(this.codigo, movimento.codigo);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Movimento
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Movimento.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Movimento is not found in the empty JSON string", Movimento.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Movimento.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Movimento` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Movimento.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Movimento' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Movimento> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Movimento.class));

       return (TypeAdapter<T>) new TypeAdapter<Movimento>() {
           @Override
           public void write(JsonWriter out, Movimento value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Movimento read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Movimento given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Movimento
   * @throws IOException if the JSON string is invalid with respect to Movimento
   */
  public static Movimento fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Movimento.class);
  }

  /**
   * Convert an instance of Movimento to an JSON string
   *
   * @return JSON string
   */
