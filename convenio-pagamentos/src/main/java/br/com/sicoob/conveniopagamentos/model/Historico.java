...
import br.com.sicoob.conveniopagamentos.model.HistoricoResultado;
...
public class Historico {
  ...
  private HistoricoResultado resultado;

  public Historico() {
  }

  public Historico resultado(@javax.annotation.Nullable HistoricoResultado resultado) {
   ...
   */
  @javax.annotation.Nullable
  public HistoricoResultado getResultado() {
    return resultado;
  }

  public void setResultado(@javax.annotation.Nullable HistoricoResultado resultado) {
    this.resultado = resultado;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resultado, historico.resultado);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Historico
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Historico.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Historico is not found in the empty JSON string", Historico.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Historico.openapiFields.contains(entry.getKey())) {
          // throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Historico` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `resultado`
      if (jsonObj.get("resultado") != null && !jsonObj.get("resultado").isJsonNull()) {
        HistoricoResultado.validateJsonElement(jsonObj.get("resultado"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Historico.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Historico' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Historico> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Historico.class));

       return (TypeAdapter<T>) new TypeAdapter<Historico>() {
           @Override
           public void write(JsonWriter out, Historico value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Historico read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Historico given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Historico
   * @throws IOException if the JSON string is invalid with respect to Historico
   */
  public static Historico fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Historico.class);
  }

  /**
   * Convert an instance of Historico to an JSON string
   *
   * @return JSON string
   */
