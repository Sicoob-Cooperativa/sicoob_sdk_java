...
|------------ | ------------- | ------------- | -------------|
|**calendario** | [**CobDataDeVencimento**](CobDataDeVencimento.md) | Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança. |  |
|**devedor** | [**DadosDevedor**](DadosDevedor.md) |  |  |
