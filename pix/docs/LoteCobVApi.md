...
import br.com.sicoob.pix.api.LoteCobVApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    LoteCobVApi apiInstance = new LoteCobVApi(defaultClient);
...
# **lotecobvIdPatch**
> lotecobvIdPatch(id, lotecobvIdPatchRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    LoteCobVApi apiInstance = new LoteCobVApi(defaultClient);
    String id = "id_example"; // String | 
    LotecobvIdPatchRequest lotecobvIdPatchRequest = new LotecobvIdPatchRequest(); // LotecobvIdPatchRequest | Dados para geração de lote de cobranças com vencimento.
    try {
      apiInstance.lotecobvIdPatch(id, lotecobvIdPatchRequest);
    } catch (ApiException e) {
...
# **lotecobvIdPut**
> lotecobvIdPut(id, lotecobvIdPutRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    LoteCobVApi apiInstance = new LoteCobVApi(defaultClient);
    String id = "id_example"; // String | 
    LotecobvIdPutRequest lotecobvIdPutRequest = new LotecobvIdPutRequest(); // LotecobvIdPutRequest | Dados para geração de lote de cobranças com vencimento.
    try {
      apiInstance.lotecobvIdPut(id, lotecobvIdPutRequest);
    } catch (ApiException e) {
