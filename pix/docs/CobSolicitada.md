...
|**calendario** | [**CobExpiracao**](CobExpiracao.md) | Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança. |  |
|**devedor** | [**CobSolicitadaAllOfDevedor**](CobSolicitadaAllOfDevedor.md) |  |  [optional] |
|**loc** | [**CobSolicitadaAllOfLoc**](CobSolicitadaAllOfLoc.md) |  |  [optional] |
