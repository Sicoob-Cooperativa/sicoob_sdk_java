...
import br.com.sicoob.pix.auth.Authentication;
import br.com.sicoob.pix.auth.HttpBasicAuth;
import br.com.sicoob.pix.auth.HttpBearerAuth;
import br.com.sicoob.pix.auth.ApiKeyAuth;
import br.com.sicoob.pix.auth.OAuth;
import br.com.sicoob.pix.auth.RetryingOAuth;
import br.com.sicoob.pix.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.sicoob.com.br/pix/api/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("oauth-mtls-sso", new OAuth());
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.0.23.28/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sicoob.com.br/pix/api/v2)
     ...
     * @return a {@link br.com.sicoob.pix.ApiClient} object
     */
    ...
    */
     ...
     * @throws br.com.sicoob.pix.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws br.com.sicoob.pix.ApiException If fail to serialize the given object
     */
     ...
     * @throws br.com.sicoob.pix.ApiException If fail to read file content from response and write to disk
     ...
     * @throws br.com.sicoob.pix.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws br.com.sicoob.pix.ApiException If the response has an unsuccessful status code or
     ...
     * @throws br.com.sicoob.pix.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws br.com.sicoob.pix.ApiException If fails to update the parameters
     */
     ...
     * @throws br.com.sicoob.pix.ApiException If fail to serialize the request body object into a string
     */
