...
import br.com.sicoob.auth.auth.Authentication;
import br.com.sicoob.auth.auth.HttpBasicAuth;
import br.com.sicoob.auth.auth.HttpBearerAuth;
import br.com.sicoob.auth.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://auth.sicoob.com.br";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://auth.sicoob.com.br)
     ...
     * @return a {@link br.com.sicoob.auth.ApiClient} object
     */
    ...
    */
     ...
     * @throws br.com.sicoob.auth.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws br.com.sicoob.auth.ApiException If fail to serialize the given object
     */
     ...
     * @throws br.com.sicoob.auth.ApiException If fail to read file content from response and write to disk
     ...
     * @throws br.com.sicoob.auth.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws br.com.sicoob.auth.ApiException If the response has an unsuccessful status code or
     ...
     * @throws br.com.sicoob.auth.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws br.com.sicoob.auth.ApiException If fails to update the parameters
     */
     ...
     * @throws br.com.sicoob.auth.ApiException If fail to serialize the request body object into a string
     */
