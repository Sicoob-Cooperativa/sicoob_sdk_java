...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new br.com.sicoob.auth.model.AuthRealmsCooperadoProtocolOpenidConnectTokenPost200Response.CustomTypeAdapterFactory());
